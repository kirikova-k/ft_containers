...
void print(Node *aNode)
{
 ...
 if (aNode->left)
 	print(aNode->left); //Выведем ветку и ее подветки слева

 for (int i = 0; i<tabs; i++) printf(" "); //Потом отступы
 printf("%d ", aNode->data); //Данные этой ветки

 if (aNode->right)
 	print(aNode->right);//И ветки, что справа
